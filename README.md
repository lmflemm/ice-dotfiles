...
My configuration files for bash, vim, tmux and so forth. Based on Mischa Van den burg's setup.
...
```bash
DOTFILES_DIR=$HOME/Repos/github.com/lmflemm
mkdir -p $DOTFILES_DIR
cd $DOTFILES_DIR
git clone https://github.com/lmflemm/mydotfiles.git
cd dotfiles
```
